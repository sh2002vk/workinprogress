...
router.post('/', authenticateRecruiter, applicationController.createApplication);
...
router.get('/:applicationID/applicants', authenticateRecruiter, applicationController.getApplicants);

// Route to delete an application
router.delete('/:applicationID', authenticateRecruiter, applicationController.deleteApplication);
